...
class StreamNode(object):
    ...
    def calc_heat_opt(self, time, hour, min, sec, doy,
        ...
        (SolarAltitude, 
         ...
         tran, 
         Azimuth_mod,
         SolarRadiusVector) = self.head.SolarPos
    ...
    def calc_heat_boundary_node(self, time, hour, min, sec, doy, JC, solar_only=False):
        # Reset temperatures
        self.T_prev = self.T
        self.T = None
        ...
        (SolarAltitude,
         ...
         tran,
         Azimuth_mod,
         SolarRadiusVector) = py_HS.calc_solar_position(self.latitude,
                                                        self.longitude,
                                                        hour,
                                                        min,
                                                        sec,
        ...
        self.SolarPos = SolarAltitude, SolarZenith, Daytime, tran, Azimuth_mod, SolarRadiusVector
