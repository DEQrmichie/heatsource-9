...
def control_file_dict():
    ...
    cf_dict = {
        ...
        "calcevap": [21, "Include Evaporation Losses From Flow (True/False)", "calcevap", None],
        "evapmethod": [22, "Evaporation Method (Mass Transfer/Penman)", "evapmethod", None],
        "wind_a": [23, "Wind Function Coefficient a", "wind_a", None],
        "wind_b": [24, "Wind Function Coefficient b", "wind_b", None],
        "calcalluvium": [25, "Include Deep Alluvium Temperature (True/False)", "calcalluvium", None],
        "alluviumtemp": [26, "Deep Alluvium Temperature (Celsius)", "alluviumtemp", None],
        "morphfile": [27, "Morphology Input Data File Name", "morphfile", None],
        "lcdatafile": [28, "Land Cover Input Data File Name", "lcdatafile", None],
        "lccodefile": [29, "Land Cover Codes Input File Name", "lccodefile", None],
        "trans_count": [30, "Number Of Transects Per Node", "trans_count", None],
        "transsample_count": [31, "Number Of Samples Per Transect", "transsample_count", None],
        "transsample_distance": [32, "Distance Between Transect Samples (meters)", "transsample_distance", None],
        "emergent": [33, "Account For Emergent Veg Shading (True/False)", "emergent", None],
        "lcdatainput": [34, "Land Cover Data Input Type (Codes/Values)", "lcdatainput", None],
